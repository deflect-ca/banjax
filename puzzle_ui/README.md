  ...
  - [Languages & Tools](#languages--tools)
    ...
    - [Tools](#tools)
      - [Bundler: Rollup](#rollup)
        - [What is Being included by Rollup](#what-is-being-included-by-rollup)
        - [Compatibility with Legacy Browsers](#compatibility-with-legacy-browsers)
          - [Polyfills](#polyfills)
  - [Project Structure](#project-structure)
    - [types (puzzle_ui/types)](#/types)
    - [src (puzzle_ui/src)](#/src)
        - [src/client](#/src/client)
            - [src/client/scripts](#/src/client/scripts)
                - [src/client/scripts/utils](#/src/client/scripts/utils)
            - [src/client/styles](#/src/client/styles)
        - [src/index.html](#/src/index.html)
        - [src/deflect_logo.svg](#/src/deflect_logo.svg)
    - [dist (puzzle_ui/dist)](#/dist)
    - [root (puzzle_ui/)](#/)
